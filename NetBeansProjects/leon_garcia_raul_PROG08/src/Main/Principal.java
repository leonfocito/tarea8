        ...
        do {
            ...
            switch (opcion) {
                case 1:
                    ...
                    c.insertaEstudiante("123456789s", "NIES000003AB", "Manuel", "paco@email.com", LocalDate.of(2000, 12,12));
                    c.insertaEstudiante("123456789s", "NIES000001AB", "Paco", "paco@email.com", LocalDate.of(2000, 12,12));
                    c.insertaEstudiante("123456789s", "NIES000002AB", "Antonio", "paco@email.com", LocalDate.of(2000, 12,12));
                    c.insertaEstudiante("123456789s", "NIES000004AB", "Manuel", "paco@email.com", LocalDate.of(2000, 12,12));
                    c.imprimeListaEstudiante();
                    c.eliminaEstudiante("NIES000004AB");
                    c.imprimeListaEstudiante();
                    /*
                    System.out.println("¿Quieres inicializar con valores de prueba?(S/N)");
...
//Comprobamos si el email es correcto 
                        ...
                        //Imprime el menú de asignaturas, guarda la asignatura seleccionaday crea el objeto con el valor de la posición reservada para esa asignatura
                        ...
                        while (opcion < 1 || opcion > 8) {
                            ...
                            if (opcion > 0 || opcion < 8) {
                                ...
                                System.out.println("El número tiene que estar entre 1 y 7");
                            }
                        }
                        try {
...
//Comprueba el correo del estudiante
                ...
                case 5:
                    if (!Curso.getCreado()) {
                        ...
                        try {
                            do {
                                System.out.println("Escoge profesor por su id");
                                for (int i = 0; i < c.getRelacionProfesores().length; i++) {
                                    if (c.getRelacionProfesores()[i] == null) {
                                        System.out.println("No hay profesor asignado");
                                    } else {
                                        System.out.println("Id: " + c.getRelacionProfesores()[i].getIdentificador() + " Nombre: " + c.getRelacionProfesores()[i].getNombreCompleto());
                                ...
                                if (c.existeProfesor(id)) {
                                    System.out.println("Id:" + id + "\n"
                                            + "Asignatura:" + c.getRelacionProfesores()[c.posProfesor(id)].getAsignatura().getDescripcion());
                                    System.out.println(Validaciones.separador(50));
                                    System.out.println(c.informeAsig(c.getRelacionProfesores()[c.posProfesor(id)].getAsignatura().getCodigo()));
                                    System.out.println(Validaciones.separador(50));
